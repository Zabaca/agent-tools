...
2. Create the worktree and bootstrap it:
   ```bash
...
3. Determine the team name and ensure it exists.
...
4. Spawn the teammate. Use the ticket id as the teammate name so it's addressable by `SendMessage`:
   ```
   Agent({
